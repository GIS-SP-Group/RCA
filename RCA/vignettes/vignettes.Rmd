---
title: "Analyzing scRNAseq data with RCA"
author: "Huipeng Li"
date: "20/03/2017"
output:
  pdf_document:
...
```{r, fig1A,fig.width=.1,out.width = "400px",echo=FALSE,message=TRUE,include=TRUE,fig.cap="Fig 1A: RCA clusters of cell line data in PCA space. Each color represents one cell type."}
knitr::include_graphics("/Users/wiseflying/R_wd/RCA_package_for_resubmission/package_folder/RCA/vignettes/results/cellline_RCAplot_PCA_external_labels.png")
```

```{r, fig1B,fig.width=.1,out.width = "400px",echo=FALSE,message=FALSE,include=TRUE,fig.cap="Fig 1B: Heat map showing reference component scores, with rows representing reference profiels and columns representing single cells."}
knitr::include_graphics("/Users/wiseflying/R_wd/RCA_package_for_resubmission/package_folder/RCA/vignettes/results/cellline_RCAplot_heatmap_external_labels.png")
```
